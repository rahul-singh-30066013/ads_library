...
class CustomTabScaffold extends StatefulWidget {
  ...
  ValueNotifier<double> heightNotifier = ValueNotifier(0);
...
class _CustomTabScaffoldState extends State<CustomTabScaffold>
  ...
  startTimer() {
    ...
    timer = Timer(const Duration(milliseconds: 1500), () {
      if (widget.heightNotifier.value == 0)
        widget.heightNotifier.value = widget.tabBar.height;
    });
  }
              ...
              child: SafeArea(
                ...
                child: ValueListenableBuilder(
                  ...
                  builder: (context, double value, child) => AnimatedContainer(
                    ...
                    height: value +
                        (value != 0 ? existingMediaQuery.padding.bottom : 0),
  ...
  bool hideUnHideTabBar(UserScrollNotification notification) {
