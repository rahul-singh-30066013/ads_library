...
class TravelSectorListView extends StatefulWidget {
  const TravelSectorListView({
    Key? key,
    this.selectedItem,
  ...
  @override
  _TravelSectorListViewState createState() => _TravelSectorListViewState();
}

class _TravelSectorListViewState extends State<TravelSectorListView> {
