...
class StandAloneServiceListScreen extends StatefulWidget {
  ///This class is for creating list of services in bottom sheet.
  const StandAloneServiceListScreen({
    Key? key,
  ...
  @override
  _StandAloneServiceListScreenState createState() =>
      _StandAloneServiceListScreenState();
}

class _StandAloneServiceListScreenState
    extends State<StandAloneServiceListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return (widget.hideTransit &&
                int.tryParse(serviceList[index].id) == transitServiceId)
            ? const SizedBox()
            : InkWell(
