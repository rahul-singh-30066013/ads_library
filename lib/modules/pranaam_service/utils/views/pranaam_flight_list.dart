...
import 'package:adani_airport_mobile/modules/pranaam_service/utils/views/pranaam_flight_list_view.dart';
...
class PranaamFlightList extends StatefulWidget {
  const PranaamFlightList(
      {Key? key, required this.response, required this.callback, required this.selectedFlight,})
      : super(key: key);
  ...
  @override
  State<PranaamFlightList> createState() => _PranaamFlightListState();
}

class _PranaamFlightListState extends State<PranaamFlightList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        ValueListenableBuilder(valueListenable: widget.response,
          builder: (BuildContext context, ADResponseState value,
              Widget? child,) {
  ...
  void _searchFLight(value){
    ...
    fliterList =_pranaamAppDataRepository.getFilteredFlightList(pranaamFlights, value);
    setState(()=>{});
  }
