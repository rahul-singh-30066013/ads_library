...
class _$_CouponRequest implements _CouponRequest {
  const _$_CouponRequest({required this.originAirportId});
  ...
  @override
  String toString() {
    return 'CouponRequest(originAirportId: $originAirportId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, originAirportId);
...
abstract class _CouponRequest implements CouponRequest {
  const factory _CouponRequest({required final int originAirportId}) =
      _$_CouponRequest;
