...
_$_PostalCodeResponseModel _$$_PostalCodeResponseModelFromJson(
        Map<String, dynamic> json) =>
    _$_PostalCodeResponseModel(
      result: json['result'] == null
          ? null
          : AddressDetailModel.fromJson(json['result'] as Map<String, dynamic>),
      results: (json['results'] as List<dynamic>?)
          ?.map((e) => AddressDetailModel.fromJson(e as Map<String, dynamic>))
          .toList(),
      status: json['status'] as String?,
    );

Map<String, dynamic> _$$_PostalCodeResponseModelToJson(
        _$_PostalCodeResponseModel instance) =>
    <String, dynamic>{
