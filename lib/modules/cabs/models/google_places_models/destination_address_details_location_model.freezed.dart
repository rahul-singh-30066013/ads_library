...
DestinationAddressDetailsLocationModel
    _$DestinationAddressDetailsLocationModelFromJson(
        Map<String, dynamic> json) {
  return _DestinationAddressDetailsLocationModel.fromJson(json);
}

/// @nodoc
mixin _$DestinationAddressDetailsLocationModel {
  ...
  @JsonKey(ignore: true)
  $DestinationAddressDetailsLocationModelCopyWith<
          DestinationAddressDetailsLocationModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DestinationAddressDetailsLocationModelCopyWith<$Res> {
  factory $DestinationAddressDetailsLocationModelCopyWith(
          DestinationAddressDetailsLocationModel value,
          $Res Function(DestinationAddressDetailsLocationModel) then) =
      _$DestinationAddressDetailsLocationModelCopyWithImpl<$Res,
          DestinationAddressDetailsLocationModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DestinationAddressDetailsLocationModelCopyWithImpl<$Res,
        $Val extends DestinationAddressDetailsLocationModel>
    implements $DestinationAddressDetailsLocationModelCopyWith<$Res> {
  _$DestinationAddressDetailsLocationModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_DestinationAddressDetailsLocationModelCopyWith<$Res>
    implements $DestinationAddressDetailsLocationModelCopyWith<$Res> {
  factory _$$_DestinationAddressDetailsLocationModelCopyWith(
          _$_DestinationAddressDetailsLocationModel value,
          $Res Function(_$_DestinationAddressDetailsLocationModel) then) =
      __$$_DestinationAddressDetailsLocationModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {AddressDetailModel? result,
...
/// @nodoc
class __$$_DestinationAddressDetailsLocationModelCopyWithImpl<$Res>
    extends _$DestinationAddressDetailsLocationModelCopyWithImpl<$Res,
        _$_DestinationAddressDetailsLocationModel>
    implements _$$_DestinationAddressDetailsLocationModelCopyWith<$Res> {
  __$$_DestinationAddressDetailsLocationModelCopyWithImpl(
      _$_DestinationAddressDetailsLocationModel _value,
      $Res Function(_$_DestinationAddressDetailsLocationModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_DestinationAddressDetailsLocationModel(
      result: freezed == result
          ? _value.result
          : result // ignore: cast_nullable_to_non_nullable
              as AddressDetailModel?,
...
/// @nodoc
@JsonSerializable()
class _$_DestinationAddressDetailsLocationModel
    implements _DestinationAddressDetailsLocationModel {
  const _$_DestinationAddressDetailsLocationModel(
      {this.result, this.results, this.status});

  factory _$_DestinationAddressDetailsLocationModel.fromJson(
          Map<String, dynamic> json) =>
      _$$_DestinationAddressDetailsLocationModelFromJson(json);
  ...
  @override
  String toString() {
    return 'DestinationAddressDetailsLocationModel(result: $result, results: $results, status: $status)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_DestinationAddressDetailsLocationModel &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DestinationAddressDetailsLocationModelCopyWith<
          _$_DestinationAddressDetailsLocationModel>
      get copyWith => __$$_DestinationAddressDetailsLocationModelCopyWithImpl<
          _$_DestinationAddressDetailsLocationModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DestinationAddressDetailsLocationModelToJson(
      this,
    );
  }
}

abstract class _DestinationAddressDetailsLocationModel
    implements DestinationAddressDetailsLocationModel {
  const factory _DestinationAddressDetailsLocationModel(
      {final AddressDetailModel? result,
      final List<AddressDetailModel>? results,
      final String? status}) = _$_DestinationAddressDetailsLocationModel;

  factory _DestinationAddressDetailsLocationModel.fromJson(
          Map<String, dynamic> json) =
      _$_DestinationAddressDetailsLocationModel.fromJson;
