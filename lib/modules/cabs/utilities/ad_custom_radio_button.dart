...
final double _kOuterRadius = 9.sp;
final double _kInnerRadius = 5.sp;
...
class AdCustomRadioButton<T> extends StatefulWidget {
  ...
  @override
  State<AdCustomRadioButton<T>> createState() => _RadioState<T>();
}

class _RadioState<T> extends State<AdCustomRadioButton<T>>
  ...
  @override
  void didUpdateWidget(AdCustomRadioButton<T> oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    switch (effectiveMaterialTapTargetSize) {
      ...
      case MaterialTapTargetSize.shrinkWrap:
        size = Size(
          kMinInteractiveDimension - context.k_8,
          kMinInteractiveDimension - context.k_8,
        );
        break;
    }
...
class _RadioPainter extends ToggleablePainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint paint = Paint()
      ..color =
          Color.lerp(inactiveColor, activeColor, position.value) ?? Colors.black
