            ...
            Flexible(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'cab_booking_confirmation_message'.localize(context),
                  ...
                  Text(
                    'cab_booking_confirmation_message_description'
                        .localize(context)
                        .replaceFirst('#-cabProvider-#', cabProvider)
                        .replaceFirst('#-terminalName-#', terminalName),
                    overflow: TextOverflow.clip,
