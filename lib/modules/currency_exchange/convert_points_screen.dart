...
import 'package:adani_airport_mobile/modules/currency_exchange/currency_exchange_builder.dart';
...
class _ConvertPointsScreenState extends State<ConvertPointsScreen>
  ...
  void initState() {
    ...
    _dashBoardViewModel.fetchCurrencyDashBoardHome();
    super.initState();
  }
  ...
  void _scrollListener() {
    ...
    dynamicTitle.value = percentageOfScroll <= percentageOfScrollScreen
        ? 'convert_points'.localize(context)
        : '';
  }
          ...
          headerSliverBuilder: (context, innerBoxIsScrolled) => <Widget>[
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceAppBar(
                context,
                title: 'convert_points'.localize(context),
                flexibleSpaceBar: expandedHeight,
                paddingLeft: context.k_20,
              ),
            ),
          ],
          body: ADSelectorStateLessWidget<CurrencyExchangeStateManagement>(
            key: const Key('DashBoard'),
            viewModel: _dashBoardViewModel,
            child: Selector<CurrencyExchangeStateManagement, ADResponseState>(
                  ...
                  case Status.complete:
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        final String title = response[index].params.widgetName;
                        return CurrencyExchangeBuilder(
