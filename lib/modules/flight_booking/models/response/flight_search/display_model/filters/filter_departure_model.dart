...
class FilterDepartureModel {
  ...
  factory FilterDepartureModel.defaultValues() => FilterDepartureModel(
        changeCode: '',
        filterCount: 0,
        filterName: 'Stops',
        filterOptions: [
