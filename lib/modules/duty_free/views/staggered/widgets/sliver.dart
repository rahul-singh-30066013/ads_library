...
import 'package:adani_airport_mobile/modules/duty_free/views/staggered/rendering/sliver_staggered_grid.dart';
import 'package:adani_airport_mobile/modules/duty_free/views/staggered/rendering/sliver_variable_size_box_adaptor.dart';
...
class SliverVariableSizeBoxAdaptorElement extends RenderObjectElement
  ...
  SliverVariableSizeBoxAdaptorElement(
    SliverVariableSizeBoxAdaptorWidget widget, {
    this.addAutomaticKeepAlives = true,
  }) : super(widget);
