...
final double paddingLeft = 73.sp;
final double paddingRight = 72.sp;

class NoPackageFound extends StatefulWidget {
  ...
  @override
  State<NoPackageFound> createState() => _NoPackageFoundState();
}

class _NoPackageFoundState extends State<NoPackageFound> {
  @override
      ...
      child: Row(
        ...
        children: [
          Expanded(
            ...
            ).paddingBySide(left: paddingLeft, right: paddingRight),
          ),
        ],
