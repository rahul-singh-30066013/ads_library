...
/// This is used to display popup for exceeded liquor limit above 200cl
class DutyFreeLitresLimitPopUp extends StatefulWidget {
  ...
  const DutyFreeLitresLimitPopUp({
    Key? key,
  ...
  @override
  _DutyFreeLitresLimitPopUpState createState() =>
      _DutyFreeLitresLimitPopUpState();
}

class _DutyFreeLitresLimitPopUpState extends State<DutyFreeLitresLimitPopUp> {
  @override
        ...
        children: [
          ...
          Center(
            child: Stack(
              ...
              children: [
                Container(
                  width: DutyFreeLitresLimitPopUp._heightCircle,
                  height: DutyFreeLitresLimitPopUp._heightCircle,
                  decoration: const BoxDecoration(
                    color: DutyFreeLitresLimitPopUp.circleColor,
                    shape: BoxShape.circle,
                  ),
                ),
                Image.asset(
                  'lib/assets/images/duty_free/Arrivalcase.png',
                  height: DutyFreeLitresLimitPopUp._imageCircle,
                  width: DutyFreeLitresLimitPopUp._imageCircle,
          ...
          Center(
            child: Text(
              'reached_limit'.localize(context),
