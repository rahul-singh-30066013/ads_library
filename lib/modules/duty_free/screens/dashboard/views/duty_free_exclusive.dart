...
import 'package:adani_airport_mobile/modules/duty_free/screens/dashboard/views/duty_free_exclusive_product_card.dart';
...
///Widget for duty free component for exclusive component
class DutyFreeExclusive extends StatelessWidget {
  final DutyFreeDashboardItem dutyFreeDashboardItem;

  const DutyFreeExclusive({
    Key? key,
...
class ExclusiveProductComponent extends StatefulWidget {
  const ExclusiveProductComponent({
    Key? key,
    required this.dutyFreeDashboardItem,
  }) : super(key: key);
  ...
  @override
  _ExclusiveProductComponentState createState() =>
      _ExclusiveProductComponentState();
}

class _ExclusiveProductComponentState extends State<ExclusiveProductComponent>
  ...
  Widget build(BuildContext context) {
    ...
    final listHeight =
        320.sp + (widget.dutyFreeDashboardItem.subItemMargin?.top.sp ?? 0);
    final scaledImageHeight = 202.sp;
    final scaledImageWidth = 268.sp;
    const listLength = 10;
                                  ...
                                  return TouchableOpacity(
                                    onTap: () =>
                                      ...
                                      argumentObject: DealProductModel(
                                        ...
                                        isExclusive: catalogListResponseModel
                                            .result[index].isExclusive,
                                      ),
                                    ),
                                    child: DutyFreeExclusiveProductCard(
                                      borderRadius: widget
                                      ...
                                      imageScaledWidth: scaledImageWidth,
                                      ...
                                      image: catalogListResponseModel
                                              ...
                                              .productImages
                                              .isNotEmpty
                                          ? '${Environment.instance.configuration.cmsImageBaseUrl}${(catalogListResponseModel.result[index].exclusiveImage?.isNotEmpty ?? false) ? catalogListResponseModel.result[index].exclusiveImage : catalogListResponseModel.result[index].productImages.first}'
                                          : '',
                                      placeHolder:
