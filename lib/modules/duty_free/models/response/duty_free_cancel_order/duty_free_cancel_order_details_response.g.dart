...
_$_DutyFreeCancelOrderDetailsResponse
    _$$_DutyFreeCancelOrderDetailsResponseFromJson(Map<String, dynamic> json) =>
        _$_DutyFreeCancelOrderDetailsResponse(
...
Map<String, dynamic> _$$_DutyFreeCancelOrderDetailsResponseToJson(
        _$_DutyFreeCancelOrderDetailsResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_$_PaidBy _$$_PaidByFromJson(Map<String, dynamic> json) => _$_PaidBy(
      ...
      loyalty: json['loyalty'] == null
          ? null
          : Loyalty.fromJson(json['loyalty'] as Map<String, dynamic>),
      promo: json['promo'],
    );
...
_$_Earning _$$_EarningFromJson(Map<String, dynamic> json) => _$_Earning(
      total: json['total'] as int?,
      reward: json['reward'] as int?,
      order: json['order'] as int?,
    );

Map<String, dynamic> _$$_EarningToJson(_$_Earning instance) =>
    <String, dynamic>{
