...
const double startPost = -15;
const double endPost = -15;
const double topPost = -8;
const double bottomPost = -18;

///this class is used to adjust badge position
class BadgePosition {
  ...
  factory BadgePosition.topEnd({double top = topPost, double end = endPost}) {
