...
const String _defaultTitle = 'Food';
...
///
class AirportFoodListScreen extends StatefulWidget {
  const AirportFoodListScreen({Key? key}) : super(key: key);

  @override
  _AirportFoodListScreenState createState() => _AirportFoodListScreenState();
}

class _AirportFoodListScreenState extends State<AirportFoodListScreen> {
  ...
  void initState() {
    super.initState();
    airportShopListState.getShopListData(JsonAssets.airportFoodListJson);
