/// bigBanner : {"uid":"1107ba94-7f38-4c0e-8a51-f1bebe2748c8","widgetType":"Big Banner","fields":[{"widgetId":1,"title":"Rahul","offer":10,"subTitle":"Singh","imageLink":"wdfwffegdeg","actionTitle":{"deeplink":"v cv cv b b "}},{"widgetId":2,"title":"Rahul","offer":10,"subTitle":"Singh","imageLink":"wdfwffegdeg","actionTitle":{"deeplink":"v cv cv b b "}}]}
...
class AdsBigBanner {
  ...
  AdsBigBanner.fromJson(dynamic json) {
    _bigBanner = json['bigBanner'] != null ? BigBanner.fromJson(json['bigBanner']) : null;
  }
  BigBanner? _bigBanner;
AdsBigBanner copyWith({  BigBanner? bigBanner,
}) => AdsBigBanner(  bigBanner: bigBanner ?? _bigBanner,
);
  BigBanner? get bigBanner => _bigBanner;

  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (_bigBanner != null) {
      map['bigBanner'] = _bigBanner?.toJson();
    }
    return map;
  }
...
class BigBanner {
  ...
  BigBanner.fromJson(dynamic json) {
    _uid = json['uid'];
  ...
  String? _widgetType;
  List<Fields>? _fields;
BigBanner copyWith({  String? uid,
  String? widgetType,
  List<Fields>? fields,
}) => BigBanner(  uid: uid ?? _uid,
