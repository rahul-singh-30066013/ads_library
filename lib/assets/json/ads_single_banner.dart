/// singleBanner : {"uid":"1107ba94-7f31-4c0e-8a51-f1bebe2748c8","widgetType":"Single Banner","fields":[{"widgetId":1,"title":"Pratap","offer":"15","subTitle":"Singh","imageLink":"https://media.geeksforgeeks.org/wp-content/cdn-uploads/20190806131525/forkPython.jpg","actionTitle":{"deeplink":"https://media.geeksforgeeks.org/wp-content/cdn-uploads/20190806131525/forkPython.jpg"}}]}

class AdsSingleBanner {
  AdsSingleBanner({
      SingleBanner? singleBanner,}){
    _singleBanner = singleBanner;
}

  AdsSingleBanner.fromJson(dynamic json) {
    _singleBanner = json['singleBanner'] != null ? SingleBanner.fromJson(json['singleBanner']) : null;
  }
  SingleBanner? _singleBanner;
AdsSingleBanner copyWith({  SingleBanner? singleBanner,
}) => AdsSingleBanner(  singleBanner: singleBanner ?? _singleBanner,
);
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_singleBanner != null) {
      map['singleBanner'] = _singleBanner?.toJson();
    }
    return map;
  }
...
class SingleBanner {
  ...
  SingleBanner.fromJson(dynamic json) {
    _uid = json['uid'];
  ...
  String? _widgetType;
  List<Fields>? _fields;
SingleBanner copyWith({  String? uid,
  String? widgetType,
  List<Fields>? fields,
}) => SingleBanner(  uid: uid ?? _uid,
